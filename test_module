...
class UnitTests(unittest.TestCase):
    ...
    def test_solutions(self):
        ...
        self.assertEqual(actual, expected, 'Expected solutions to be correctly displayed in output when calling "arithmetic_formatter()" with arithmetic problems and a second argument of `True`.')
